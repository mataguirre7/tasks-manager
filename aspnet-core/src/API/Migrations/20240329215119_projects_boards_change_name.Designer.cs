...
namespace API.Migrations
{
    ...
    [Migration("20240329215119_projects_boards_change_name")]
    partial class projects_boards_change_name
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Domain.Boards.Board", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Tks.Boards", (string)null);
                });
            ...
            modelBuilder.Entity("API.Domain.Columns.Column", b =>
                {
                    b.HasOne("API.Domain.Boards.Board", "Board")
                        .WithMany("Columns")
